...
<html>
    ...
    <body class="container-fluid">
        <header id="header-box">
            <nav id="header-nav">
                <a href="ControlUser?accion2=listar"><button id="btn-regresar" class="btn btn-info"  name="accion2" value="listar">Volver a registros</button></a>
            </nav>
        </header>
        ...
        <div>
          ...
          %>
            ...
            <form action="ControlUser" class="form-group">            
                ...
                <input  type="text" name="txt_identificacion_usuario" value="<%= p.getIdentificacion_usuario()%>" class="form-control">
                <label class="label">Nombre Usuario:</label>
                <input type="text" name="txt_nombre_usuario" value="<%= p.getNombre_usuario()%>" class="form-control">
                <label class="label">Teléfono:</label>
                <input type="text" name="txt_telefono_usuario" value="<%= p.getTelefono_usuario()%>" class="form-control">
                <label class="label">Direccion:</label>
                <input type="text" name="txt_direccion_usuario" value="<%= p.getDireccion_usuario()%>" class="form-control">
                <label class="label">Mascota:</label>
                <input type="text" name="txt_mascota_usuario" value="<%= p.getNombre_mascota_usuario()%>"  class="form-control">
                <label class="label">Referencia:</label>
                <input type="text" name="txt_mascota_referencia_usuario" value="<%= p.getNumero_referencia()%>"  class="form-control">
                <!--Este input hidden recibira el id-->
                <input type="hidden" name="txtid" value="<%= p.getId_usuario()%>">
                
                <button type="submit" name="accion2" value="Actualizar" id="btn-regresar" class="btn btn-info" >Actualizar</button>
